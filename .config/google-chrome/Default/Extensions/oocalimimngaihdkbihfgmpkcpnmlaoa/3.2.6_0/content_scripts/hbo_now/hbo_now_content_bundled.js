(() => {
    ...
    __webpack_require__.r = exports => {
                  ...
                  case PopupMessageType.SET_CHAT_VISIBLE:
                    {
                        ...
                        return this._setChatVisible(visibleMessage.data), this._browseScript.setChatButtons(), 
                        sendResponse(), !1;
                    }
        ...
        let HboVideoType, StreamingServiceName;
        ...
        const DEFAULT_TEARDOWN = {
            ...
            showAlert: !0,
            alertModal: invalidNextEpisodeModal
        }, FAILED_NEXT_EPISODE_DATA = {
            showAlert: !0,
            alertModal: failedNextEpisodeModal
        }, WRONG_SCREEN_DATA = {
            showAlert: !0,
            alertModal: wrongScreenModal
        };
        ...
        class ChatEventListener {
            ...
            onIdleWarning() {
                ...
                Messaging_MessagePasser.sendMessageToExtension(idleWarnMessage), this._idleKickTimeout = setTimeout(this.onIdleTimeout.bind(this), 6e4);
            }
            onIdleTimeout() {
        ...
        var css_alert = __webpack_require__(39), css_chat = __webpack_require__(5644);
        __webpack_require__(3630);
        class HboNowChatApi extends class {
            constructor() {
            ...
            setChatVisible(visible) {
                super.setChatVisible(visible), this._shouldChatBeVisible = visible;
                const hboDivs = jQuery("div"), summaryWrapper = jQuery(hboDivs.find("[style*='user-select']")[0]).next();
                visible ? (jQuery("#chat-wrapper").show(), summaryWrapper.hide(), document.hasFocus() || this.clearUnreadCount()) : (jQuery("#chat-wrapper").hide(), 
                summaryWrapper.show(), jQuery(window).trigger("resize"));
            }
        }
        ...
        function HboNowVideoApi_defineProperty(obj, key, value) {
            return key in obj ? Object.defineProperty(obj, key, {
                value,
                enumerable: !0,
                configurable: !0,
        ...
        class HboNowVideoApi extends class {
            constructor() {
            ...
            constructor() {
                super(), HboNowVideoApi_defineProperty(this, "_getPlayItemEvent", void 0), HboNowVideoApi_defineProperty(this, "_playEvent", void 0), 
                HboNowVideoApi_defineProperty(this, "_pauseEvent", void 0), HboNowVideoApi_defineProperty(this, "_playCheckRunning", void 0), 
                HboNowVideoApi_defineProperty(this, "playItem", void 0), HboNowVideoApi_defineProperty(this, "playItemUpdatedAt", void 0), 
                HboNowVideoApi_defineProperty(this, "parseVideoId", void 0), HboNowVideoApi_defineProperty(this, "nextEpisodeUpdatedAt", void 0), 
                HboNowVideoApi_defineProperty(this, "videoTimeOffset", 0), HboNowVideoApi_defineProperty(this, "_videoType", void 0), 
                HboNowVideoApi_defineProperty(this, "videoTitle", void 0), HboNowVideoApi_defineProperty(this, "_videoId", void 0), 
                this._getPlayItemEvent = new CustomEvent("tpVideoNode", {
                    detail: {
                        type: "getPlayItem"
                    }
                }), this._playEvent = new CustomEvent("tpVideoNode", {
                    detail: {
                        type: "play"
                    }
                ...
                }), this._playCheckRunning = !0, this._uiEventsHappening = 0, this.nextEpisodeUpdatedAt = 0, 
                this._videoType = Services_HboNow.getVideoType(new URL(window.location.href));
            }
            get videoType() {
            ...
            episodeDataInteraction(event) {
                event.source == window && event.data.type && "EPISODE_ID" == event.data.type && (this.parseVideoId = event.data.episodeId, 
                this.nextEpisodeUpdatedAt = Date.now());
            }
            isVideoReady() {
            ...
            onNode(evt) {
                ...
                this.videoTimeOffset = 1e3 * evt.detail.videoTimeOffset; else if ("ManualClick" == evt.detail.type) {
            ...
            checkUpdateId(nextEpisodeId) {
                this.parseVideoId == nextEpisodeId && (debug("Updated using parsed id"), this._videoId = this.parseVideoId);
            }
            _getDefaultVideoId() {
                return Services_HboNow.getVideoId(new URL(window.location.href));
            }
            async waitVideoIdReady() {
                this._videoId || (getHBOVideoType(window.location.href) == HboVideoType.HBO_EPISODE ? await this.updateVideoId() : this._videoId = this._getDefaultVideoId());
            }
            async updateVideoId() {
                var _this$_getVideoTitle;
                const startTime = (new Date).getTime(), triggerEvent = new CustomEvent("TPBrowse", {
                    detail: {
                        type: "TOGGLE_LIST"
                    }
                });
                window.dispatchEvent(triggerEvent), await delayUntil((() => null != this.nextEpisodeUpdatedAt && this.nextEpisodeUpdatedAt > startTime), 1e4)(), 
                this._videoId = this.parseVideoId, this.videoTitle = null !== (_this$_getVideoTitle = this._getVideoTitle()) && void 0 !== _this$_getVideoTitle ? _this$_getVideoTitle : "", 
                debug("Got Video Title: " + this.videoTitle);
            }
            async waitVideoApiReadyAsync() {
                await this.waitVideoIdReady(), await this.skipPromo();
            }
            ...
            getStateAsync() {
                return new Promise(((resolve, reject) => {
                    ...
                    const playbackState = this._getPlaybackState(), playbackPositionMilliseconds = null !== (_this$_getCurrentTime = this._getCurrentTime()) && void 0 !== _this$_getCurrentTime ? _this$_getCurrentTime : 0;
                    null !== playbackState && void 0 !== playbackPositionMilliseconds ? resolve({
                        playbackState,
            ...
            removeVideoCover() {
                if (!jQuery("[style*='btn_play_large_initial']").length || !jQuery("[style*='btn_play_large_initial']").is(":visible")) return !1;
            ...
            getStreamingServiceName() {
                return StreamingServiceName.HBO_NOW;
            }
            async skipPromo() {
                try {
                    this._playCheckRunning = !0;
                    const startTime = Date.now();
                    if (window.dispatchEvent(this._getPlayItemEvent), this.removeVideoCover(), await delayUntil((() => (window.dispatchEvent(this._getPlayItemEvent), 
                    null != this.playItemUpdatedAt && null != this.playItem && startTime <= this.playItemUpdatedAt)), 2e3)(), 
                    "MAIN" === this.playItem.type) this._playCheckRunning = !1; else if ("PROMO" === this.playItem.type) {
                        debug("Skipping promo video");
                        ...
                        const seekEvent = new CustomEvent("tpVideoNode", {
                            detail: {
                                type: "seek",
                                time: this.playItem.duration
                            }
                        });
                        window.dispatchEvent(seekEvent), await delayUntil((() => (window.dispatchEvent(this._getPlayItemEvent), 
                        null != this.playItem && "MAIN" === this.playItem.type)), 3500)(), this._playCheckRunning = !1;
                    }
                    const reloadListenerEvent = new CustomEvent("reloadVideoListener");
                    window.dispatchEvent(reloadListenerEvent);
                } catch (err) {
                    await this.skipPromo();
                }
            }
            async jumpToNextEpisode(nextEpisodeMessageData) {
                if (this._videoId !== nextEpisodeMessageData.videoId) {
                    this._uiEventsHappening += 1;
                    try {
                        await this._clickUpNext(0);
                    } catch (error) {
                        debug("Click next episode failed, but we will wait and see if the video changes in time.");
                    } finally {
                        this._uiEventsHappening -= 1;
                    }
                }
            ...
            async _clickUpNext(attempts) {
                try {
                    const videoElement = this.getVideoElement();
                    if (null === videoElement) throw new Error("Video element not found.");
                    if (videoElement.currentTime = videoElement.duration, this._showControls(), await delayUntil((() => jQuery("[style*='btn_close']").parent().parent().is(":visible") || jQuery("[style*='btn_arrow']").parent().parent().is(":visible")), 2e3)(), 
                    jQuery("[style*='btn_arrow_up']").is(":visible")) {
                        jQuery("[style*='btn_arrow_up']").addClass("upArrow");
                        const uparrow = document.querySelector(".upArrow");
                        null !== uparrow && (this._clickAtProgress(uparrow, .5, "mousedown"), this._clickAtProgress(uparrow, .5, "mouseup")), 
                        await delay(500)();
                    }
                    ...
                    const nextEpisodeHolder = document.querySelector(".nextEpisodeHolder");
                    nextEpisodeHolder ? (this._clickAtProgress(nextEpisodeHolder, .5, "mousedown"), 
                    this._clickAtProgress(nextEpisodeHolder, .5, "mouseup")) : debug("Couldn't find next episode holder"), 
                    await delayUntil((() => !(jQuery("[style*='btn_close']").parent().parent().is(":visible") || jQuery("[style*='btn_arrow']").parent().parent().is(":visible"))), 2e3)();
                } catch (error) {
                    if (attempts < 2) return console.error(error), debug("Attempting next episode click again"), 
                    await this._clickUpNext(attempts + 1);
                    throw error;
                }
            }
            _getDuration() {
                var _this$getVideoElement;
                return null === (_this$getVideoElement = this.getVideoElement()) || void 0 === _this$getVideoElement ? void 0 : _this$getVideoElement.duration;
            }
            _getCurrentTime() {
                const video = this.getVideoElement();
            ...
            _getPlaybackState() {
                const video = this.getVideoElement();
                return null === video || this.playItem && "PROMO" === this.playItem.type ? PlaybackState.NOT_READY : video.readyState < 4 ? PlaybackState.LOADING : video.paused ? PlaybackState.PAUSED : PlaybackState.PLAYING;
            }
            _getVideoTitle() {
                try {
                    var _innerText, _document$querySelect, _document$querySelect2;
                    return null !== (_innerText = null === (_document$querySelect = document.querySelector("[style*='street2_thin']")) || void 0 === _document$querySelect || null === (_document$querySelect2 = _document$querySelect.children[1]) || void 0 === _document$querySelect2 ? void 0 : _document$querySelect2.innerText) && void 0 !== _innerText ? _innerText : void 0;
                } catch (e) {
                    return;
                }
            }
            ...
            getUpdateSessionDataAsync() {
                return new Promise(((resolve, reject) => {
                    (async () => {
                        ...
                        if (void 0 === currentTime) return void reject();
        ...
        function HboNowVideoEventListener_defineProperty(obj, key, value) {
            return key in obj ? Object.defineProperty(obj, key, {
                value,
                enumerable: !0,
                configurable: !0,
        ...
        class HboNowVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                super(videoApi), HboNowVideoEventListener_defineProperty(this, "_chatApi", void 0), 
                HboNowVideoEventListener_defineProperty(this, "_videoApi", void 0), HboNowVideoEventListener_defineProperty(this, "_coverObserver", void 0), 
                HboNowVideoEventListener_defineProperty(this, "_coverCheckRunning", void 0), HboNowVideoEventListener_defineProperty(this, "_onUpdate", this._onVideoUpdate.bind(this)), 
                HboNowVideoEventListener_defineProperty(this, "_onBuffering", this._onVideoBuffering.bind(this)), 
                HboNowVideoEventListener_defineProperty(this, "_onCanPlay", this._onVideoCanPlay.bind(this)), 
                HboNowVideoEventListener_defineProperty(this, "_onReplace", this.replaceStateInteraction.bind(this)), 
                HboNowVideoEventListener_defineProperty(this, "_onEpisodeData", void 0), HboNowVideoEventListener_defineProperty(this, "_onReload", this.reloadListeners.bind(this)), 
                HboNowVideoEventListener_defineProperty(this, "_onNodeMessage", void 0), HboNowVideoEventListener_defineProperty(this, "_coverCheckInterval", void 0), 
                this._videoApi = videoApi, this._coverCheckRunning = !1, this._chatApi = chatApi, 
                this._coverObserver = new MutationObserver(this.onCoverChanged.bind(this)), this._onEpisodeData = this._videoApi.episodeDataInteraction.bind(this._videoApi), 
                this._onNodeMessage = this._videoApi.onNode.bind(this._videoApi), window.replaceScriptLoaded || (debug("injecting replace script"), 
                function(script) {
                ...
                window.injectScriptLoaded || function(scriptLocation) {
                    ...
                    s.remove();
                }(chrome.extension.getURL("content_scripts/hbo_now/hbo_now_injected_bundled.js")), 
                this.initListeners();
            }
            onCoverChanged() {
            ...
            async onCoverChangedAsync() {
                ...
                if (!(this._coverCheckRunning || null !== (_this$_videoMessageFo = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo && _this$_videoMessageFo.changingVideo)) {
                    ...
                    try {
                        ...
                        await delay(500)(), null === (_this$_videoMessageFo2 = this._videoMessageForwarder) || void 0 === _this$_videoMessageFo2 || !_this$_videoMessageFo2.changingVideo) TaskManager_TaskManager.pushTask(this._videoApi.skipPromo.bind(this._videoApi)), 
            ...
            async fixPromo() {
                if (!this._videoApi.playCheckRunning) {
                    ...
                    try {
                        ...
                        if (await this._videoApi.waitTillPromo(), null !== (_this$_videoMessageFo4 = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo4 && _this$_videoMessageFo4.changingVideo) this._videoApi.playCheckRunning = !1; else TaskManager_TaskManager.pushTask(this._videoApi.skipPromo), 
            ...
            reloadListeners() {
                ...
                video && (video.addEventListener("waiting", this._onBuffering), video.addEventListener("buffering", this._onCanPlay), 
                video.addEventListener("play", this._onUpdate), video.addEventListener("pause", this._onUpdate), 
                video.addEventListener("seeking", this._onUpdate));
                const fs = getFullScreenButton();
                fs ? (fs.removeEventListener("mousedown", this.onFullScreen), fs.addEventListener("mousedown", this.onFullScreen)) : debug("Can't find fullscreen button");
            }
            initListeners() {
            ...
            getPlayCover() {
                return document.querySelector("[style*='btn_play_large_initial']");
            }
            getFullScreenButton() {
            ...
            _resizeHandler() {
                delay(100)(void 0).then((() => {
                    const hboDivs = jQuery("div");
                    if (hboDivs.find("[style*='user-select']").length > 0) {
                        debug("resize now");
                        const chatWrapper = jQuery("#chat-wrapper")[0];
                        jQuery(chatWrapper).hide();
                        const summaryWrapper = jQuery(hboDivs.find("[style*='user-select']")[0]).next(), summaryLeft = summaryWrapper.css("left"), summaryWidth = summaryWrapper.css("width");
                        debug("summaryLeft, summaryWidth: " + summaryLeft + ", " + summaryWidth), "0px" !== summaryLeft && (jQuery(chatWrapper).css("left", summaryLeft), 
                        jQuery(chatWrapper).css("width", summaryWidth)), this._chatApi.getChatVisible() && (jQuery(chatWrapper).show(), 
                        jQuery("#chat-history").scrollTop(jQuery("#chat-history").prop("scrollHeight")));
                    } else debug("no resize fullscreenchange?");
                }));
            }
                ...
                await new Promise(((resolve, reject) => {
                    const start = performance.now(), interval = setInterval((() => {
                        if (this._videoApi.videoId === nextEpisodeId) {
                            ...
                            resolve());
                        } else this._videoApi.checkUpdateId(nextEpisodeId);
            ...
            replaceStateInteraction(event) {
                ...
                const episodePage = Services_HboNow.getVideoType(new URL(window.location.href)) != HboVideoType.NONE;
                if ("FROM_PAGE_POP" !== event.data.type && episodePage) {
                    if (event.data.type && "FROM_PAGE" == event.data.type) {
                        var _this$_videoMessageFo7, _this$_videoMessageFo6;
                        if (debug("***********************************"), debug("Content script received: " + event.data.text), 
                        "episode" !== this._videoApi.videoType || "episode" !== Services_HboMax.getVideoType(new URL(window.location.href))) return void (null !== (_this$_videoMessageFo6 = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo6 && _this$_videoMessageFo6.changingVideo ? this._onTeardown(INVALID_NEXT_EPISODE_DATA) : this._onTeardown(WRONG_SCREEN_DATA));
                        if (null !== (_this$_videoMessageFo7 = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo7 && _this$_videoMessageFo7.changingVideo) return;
                        this._videoMessageForwarder && (this._videoMessageForwarder.changingVideo = !0), 
                        delayUntil(this._videoApi.tryUpdateVideoTitle.bind(this._videoApi), 1e4)().then(this._videoApi.updateVideoId.bind(this._videoApi)).then((() => {
                            var _this$_videoMessageFo8;
                            const nextVideoId = this._videoApi.videoId;
                            nextVideoId && nextVideoId != (null === (_this$_videoMessageFo8 = this._videoMessageForwarder) || void 0 === _this$_videoMessageFo8 ? void 0 : _this$_videoMessageFo8.videoId) && this._onNextEpisode(nextVideoId);
                        })).catch((err => {
                            var _this$_videoMessageFo9, _this$_videoMessageFo10;
                            (debug(err), this._videoApi.videoId !== (null === (_this$_videoMessageFo9 = this._videoMessageForwarder) || void 0 === _this$_videoMessageFo9 ? void 0 : _this$_videoMessageFo9.videoId)) && (null !== (_this$_videoMessageFo10 = this._videoMessageForwarder) && void 0 !== _this$_videoMessageFo10 && _this$_videoMessageFo10.changingVideo ? this._onTeardown(FAILED_NEXT_EPISODE_DATA) : this._onTeardown(INVALID_NEXT_EPISODE_DATA));
                        }));
                    }
                } else this._onTeardown(DEFAULT_TEARDOWN);
            }
        }
        class HboNowContentScript extends class {
            ...
            constructor() {
                const chatApi = new HboNowChatApi, videoApi = new HboNowVideoApi;
                super(chatApi, videoApi, new HboNowVideoEventListener(videoApi, chatApi));
            }
        }
        window.teleparty && window.teleparty.contentScriptInjected || (window.teleparty || (window.teleparty = {}), 
        window.teleparty.contentScriptInjected = !0, new HboNowContentScript);
    })();
})();