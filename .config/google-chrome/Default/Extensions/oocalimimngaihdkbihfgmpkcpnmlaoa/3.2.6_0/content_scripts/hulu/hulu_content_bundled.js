(() => {
    ...
    __webpack_require__.r = exports => {
        ...
        let PlaybackState, HboVideoType, SessionState;
        ...
        class HuluChatApi extends class {
            ...
            setChatVisible(visible) {
                ...
                jQuery("#dash-player-container").removeClass("with-chat")), document.fullscreen && (visible ? this.onEnterFullScreen() : this.onExitFullScreen());
            }
            fixFullScreen() {
                document.fullscreen ? this.onEnterFullScreen() : this.onExitFullScreen();
            }
            onVideoChange() {
                debug("On video change called."), this.getChatVisible() && this.fixFullScreen();
            }
            getChatVisible() {
        ...
        class HuluVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                ...
                })), this._videoObserver = new MutationObserver(this._chatApi.onVideoChange.bind(this._chatApi)), 
        ...
        class HuluPageControls extends class {
            constructor(chatApi) {
            ...
            startEventListener() {
                this.showTpIcon(), this._controlsObserver = new MutationObserver((mutationsList => {
                    jQuery(".ViewModeControlBar").parent().is(":visible") ? this.showTpIcon() : this.hideTpIcon();
                }));
                const topControls = jQuery(".ViewModeControlBar").parent();
                this._controlsObserver.observe(topControls[0], {
                    attributes: !0,
                    characterData: !0,
                    childList: !0
                });
        ...
        class HuluContentScript extends class {
            ...
            constructor() {
                const huluVideoApi = new HuluVideoApi, huluChatApi = new HuluChatApi, videoEventListener = new HuluVideoEventListener(huluVideoApi, huluChatApi);
                let pageControls;
                window.teleparty && window.teleparty.pageControls ? (pageControls = window.teleparty.pageControls, 
                console.log("Using HuluPageControls page controls")) : pageControls = new HuluPageControls(huluChatApi), 
                super(huluChatApi, huluVideoApi, videoEventListener, pageControls), debug("Hulu Content Script");
            }
        }
        window.teleparty && window.teleparty.contentScriptInjected || (window.teleparty || (window.teleparty = {}), 
        window.teleparty.contentScriptInjected = !0, new HuluContentScript, debug("Initialized content script"));
    })();
})();