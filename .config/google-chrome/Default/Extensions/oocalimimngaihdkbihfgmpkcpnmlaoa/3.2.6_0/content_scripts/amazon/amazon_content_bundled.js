(() => {
    ...
    __webpack_require__.r = exports => {
        ...
        let HboVideoType, PlaybackState, SessionState, VideoType, StreamingServiceName;
        ...
        class AmazonChatApi extends class {
            ...
            setChatVisible(visible) {
                super.setChatVisible(visible), visible ? (jQuery(".webPlayerSDKContainer").addClass("with-chat"), 
                jQuery("#chat-wrapper").show(), document.hasFocus() || this.clearUnreadCount()) : (jQuery(".webPlayerSDKContainer").removeClass("with-chat"), 
                jQuery("#chat-wrapper").hide(), jQuery(window).trigger("resize")), this.setFullScreenVisible(visible);
            }
            setFullScreenVisible(visible) {
                document.webkitIsFullScreen && (visible ? (jQuery("video").addClass("videoFullscreenWithChat"), 
            ...
            onVideoResize() {
                delay(100)().then((() => {
                    this.shouldChatBeVisible() && (document.webkitIsFullScreen ? (jQuery("video").addClass("videoFullscreenWithChat"), 
                    jQuery(".webPlayerSDKUiContainer").addClass("with-chat")) : (jQuery("video").removeClass("videoFullscreenWithChat"), 
                    jQuery(".webPlayerSDKUiContainer").removeClass("with-chat")));
                }));
            }
        ...
        class AmazonVideoApi extends class {
            ...
            async waitVideoApiReadyAsync() {
                ...
                await delayUntil(this.isVideoReady.bind(this), 1 / 0)(), await this.skipPromo(), 
                await this.waitVideoIdReady(), this.videoType = this.getVideoType();
            }
            ...
            isPlayerPage() {
                return !!window.location.href.includes("?autoplay=1") || null != document.querySelector(".rendererContainer video") && null != document.querySelector(".dv-player-fullscreen");
            }
            _getPlaybackState() {
                const video = this.getVideoElement();
                let playbackState;
        ...
        class AmazonPageControls extends class {
            constructor(chatApi) {
            ...
            constructor() {
                var obj, key, value;
                super(...arguments), value = void 0, (key = "_controlsObserver") in (obj = this) ? Object.defineProperty(obj, key, {
                    value,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
            ...
            async getControlsRoot() {
                return await delayUntil(this.isPlayerPage, 1 / 0)(), console.log("Found player page"), 
            ...
            startEventListener() {
                console.log("Started"), this.showTpIcon(), this._controlsObserver = new MutationObserver((() => {
                    const topContainer = document.querySelector(".atvwebplayersdk-hideabletopbuttons-container");
                    topContainer && (topContainer.classList.contains("hide") ? this.hideTpIcon() : this.showTpIcon());
                }));
                const topContainer = document.querySelector(".atvwebplayersdk-hideabletopbuttons-container");
                topContainer ? this._controlsObserver.observe(topContainer, {
                    attributes: !0
                }) : setTimeout(this.startEventListener.bind(this), 1e3);
            }
            stopEventListener() {
        ...
        class AmazonContentScript extends class {
            ...
            constructor() {
                const amazonChatApi = new AmazonChatApi, amazonVideoApi = new AmazonVideoApi, videoEventListener = new AmazonVideoEventListener(amazonVideoApi, amazonChatApi);
                let pageControls;
                window.teleparty && window.teleparty.pageControls ? (pageControls = window.teleparty.pageControls, 
                console.log("Using HuluPageControls page controls")) : pageControls = new AmazonPageControls(amazonChatApi), 
                super(amazonChatApi, amazonVideoApi, videoEventListener, pageControls), debug("Amazon Content Script");
            }
        }
        window.teleparty && window.teleparty.contentScriptInjected || (window.teleparty || (window.teleparty = {}), 
        window.teleparty.contentScriptInjected = !0, new AmazonContentScript, debug("Listening to messages"));
    })();
})();