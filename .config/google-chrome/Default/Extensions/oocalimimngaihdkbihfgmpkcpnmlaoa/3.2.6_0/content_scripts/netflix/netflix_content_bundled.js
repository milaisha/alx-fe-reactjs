(() => {
    ...
    __webpack_require__.r = exports => {
        ...
        const Services_Netflix = Netflix, VideoLoadError = "Failed to load video in time. Please refresh the page and try again.", GenericErrorMessage = "An unexpected error occured. Please refresh the page and try again.";
        function NetflixVideoApi_defineProperty(obj, key, value) {
            return key in obj ? Object.defineProperty(obj, key, {
                value,
                enumerable: !0,
                configurable: !0,
        ...
        class NetflixVideoApi extends class {
            ...
            async waitVideoApiReadyAsync() {
                if (!this._video) try {
                    ...
                    }), 1 / 0)(), console.log("Got video"), this._video = null !== (_document$querySelect = document.querySelector("video")) && void 0 !== _document$querySelect ? _document$querySelect : void 0;
                } catch (error) {
            ...
            async jumpToNextEpisode(nextEpisodeMessageData) {
                ...
                if (urlVideoId != parseInt(nextEpisodeMessageData.videoId)) if (urlVideoId && urlVideoId + 1 === parseInt(nextEpisodeMessageData.videoId)) {
            ...
            _getVideoIdFromCurrentUrl() {
                ...
                return 0 !== (null !== (_window$location$href = window.location.href.match(/^.*\/([0-9]+)\??.*/)) && void 0 !== _window$location$href ? _window$location$href : "").length ? parseInt(null !== (_ = (null !== (_window$location$href2 = window.location.href.match(/^.*\/([0-9]+)\??.*/)) && void 0 !== _window$location$href2 ? _window$location$href2 : [])[1]) && void 0 !== _ ? _ : null) : null;
            }
            freeze(milliseconds) {
            ...
            async pause() {
                this._uiEventsHappening += 1, window.postMessage({
                    type: "PAUSE"
                }, "*"), await this.waitUpdateAPIState(), await delay(500)();
                try {
                    await delayUntil((() => (window.postMessage({
                        type: "GetState"
                    }, "*"), this._playerState.paused)), 2500)(), await this._hideControls(), console.log("Paused");
                } catch (e) {
                    console.log("Didn't pause, but continuing.");
                } finally {
                    this._uiEventsHappening -= 1;
                }
            }
            async play() {
                ...
                try {
                    await delayUntil((() => (window.postMessage({
                        type: "GetState"
                    }, "*"), !this._playerState.paused)), 2500)(), await this._hideControls(), console.log("Played");
                } catch (e) {
                    console.log("Didn't play, but continuing.");
                } finally {
                    this._uiEventsHappening -= 1;
                }
            }
            ...
            _hideControls() {
                var _windowJquery$scrollL, _windowJquery$scrollT, _windowJquery$scrollL2, _windowJquery$scrollT2, _player$offset$left, _player$offset, _player$offset$top, _player$offset2;
                this._uiEventsHappening += 1;
                const player = jQuery(".VideoContainer"), windowJquery = jQuery(window), eventOptions = {
                    bubbles: !0,
                    button: 0,
                    screenX: 100 - (null !== (_windowJquery$scrollL = windowJquery.scrollLeft()) && void 0 !== _windowJquery$scrollL ? _windowJquery$scrollL : 0),
                    screenY: 100 - (null !== (_windowJquery$scrollT = windowJquery.scrollTop()) && void 0 !== _windowJquery$scrollT ? _windowJquery$scrollT : 0),
                    clientX: 100 - (null !== (_windowJquery$scrollL2 = windowJquery.scrollLeft()) && void 0 !== _windowJquery$scrollL2 ? _windowJquery$scrollL2 : 0),
                    clientY: 100 - (null !== (_windowJquery$scrollT2 = windowJquery.scrollTop()) && void 0 !== _windowJquery$scrollT2 ? _windowJquery$scrollT2 : 0),
                    offsetX: 100 - (null !== (_player$offset$left = null === (_player$offset = player.offset()) || void 0 === _player$offset ? void 0 : _player$offset.left) && void 0 !== _player$offset$left ? _player$offset$left : 0),
                    offsetY: 100 - (null !== (_player$offset$top = null === (_player$offset2 = player.offset()) || void 0 === _player$offset2 ? void 0 : _player$offset2.top) && void 0 !== _player$offset$top ? _player$offset$top : 0),
                    pageX: 100,
                    pageY: 100,
            ...
            _getVideoId() {
                var _Netflix$getVideoId;
                const currVideoId = null !== (_Netflix$getVideoId = Services_Netflix.getVideoId(new URL(window.location.href))) && void 0 !== _Netflix$getVideoId ? _Netflix$getVideoId : "", videoDomId = void 0 !== jQuery("video").parent()[0] ? jQuery("video").parent()[0].id : null;
                let tempVideoId = currVideoId;
                return null != videoDomId && "" != videoDomId && videoDomId != currVideoId && (debug("Replacing with dom id"), 
        ...
        class NetflixChatApi extends class {
            ...
            constructor() {
                super(), NetflixChatApi_defineProperty(this, "_shouldBeFocused", !0), NetflixChatApi_defineProperty(this, "_selectionStart", 0), 
                NetflixChatApi_defineProperty(this, "_selectionEnd", 0), NetflixChatApi_defineProperty(this, "_selectionDirection", "forward"), 
                NetflixChatApi_defineProperty(this, "chatWrapper", void 0);
            }
            onClick(e) {
                e.target === jQuery("#chat-input")[0] || e.target === jQuery("#nickname-edit")[0] ? (this.updateSelectionRange(), 
                this._shouldBeFocused = !0) : this._shouldBeFocused = !1;
            }
            onBlur(e) {
                if (this._shouldBeFocused) if (jQuery("#chat-input").focus(), jQuery("#nickname-edit").is(":visible")) {
                    jQuery("#nickname-edit")[0].focus();
                } else {
                    const input = jQuery("#chat-input")[0];
                    input.focus(), input.setSelectionRange(this._selectionStart, this._selectionEnd, this._selectionDirection);
                }
            }
            updateSelectionRange() {
                var _input$selectionStart, _input$selectionEnd, _input$selectionDirec;
                const input = jQuery("#chat-input")[0];
                this._selectionStart = null !== (_input$selectionStart = input.selectionStart) && void 0 !== _input$selectionStart ? _input$selectionStart : 0, 
                this._selectionEnd = null !== (_input$selectionEnd = input.selectionEnd) && void 0 !== _input$selectionEnd ? _input$selectionEnd : 0, 
                this._selectionDirection = null !== (_input$selectionDirec = input.selectionDirection) && void 0 !== _input$selectionDirec ? _input$selectionDirec : "forward";
            }
            initCustomListeners() {
                console.log("Init Custom Listeners"), jQuery("#chat-input").on("blur", this.onBlur.bind(this)), 
                jQuery("#nickname-edit").on("blur", this.onBlur.bind(this)), window.addEventListener("click", this.onClick.bind(this)), 
            ...
            onChatKeyDown(event) {
                super.onChatKeyDown(event), this._shouldBeFocused = !0, document.querySelector("[data-uia='controls-standard']") && window.postMessage({
                    type: "ShowControls"
                }, "*");
            }
            _injectChat() {
            ...
            removeChat() {
                var _this$chatWrapper, _this$chatWrapper2;
                ...
                null === (_this$chatWrapper2 = this.chatWrapper) || void 0 === _this$chatWrapper2 || _this$chatWrapper2.removeClass("tp-video");
            }
            getChatVisible() {
                var _this$chatWrapper$has, _this$chatWrapper3;
                return null !== (_this$chatWrapper$has = null === (_this$chatWrapper3 = this.chatWrapper) || void 0 === _this$chatWrapper3 ? void 0 : _this$chatWrapper3.hasClass("with-chat")) && void 0 !== _this$chatWrapper$has && _this$chatWrapper$has;
            }
            setChatVisible(visible) {
                if (this.fixRTL(), super.setChatVisible(visible), visible) {
                    var _this$chatWrapper4;
                    jQuery("#chat-wrapper").length || this.reloadChat(), jQuery("#chat-wrapper").animate({
                        width: 288
                    }, 250), null === (_this$chatWrapper4 = this.chatWrapper) || void 0 === _this$chatWrapper4 || _this$chatWrapper4.addClass("with-chat"), 
                    document.hasFocus() || this.clearUnreadCount();
                } else {
                    var _this$chatWrapper5;
                    jQuery("#chat-wrapper").animate({
                        width: 0
                    }, 250), null === (_this$chatWrapper5 = this.chatWrapper) || void 0 === _this$chatWrapper5 || _this$chatWrapper5.removeClass("with-chat");
                }
                delay(400)().then((() => {
        ...
        function NetflixVideoEventListener_defineProperty(obj, key, value) {
            return key in obj ? Object.defineProperty(obj, key, {
                value,
                enumerable: !0,
                configurable: !0,
        ...
        class NetflixVideoEventListener extends class {
            ...
            constructor(videoApi, chatApi) {
                ...
                this._videoApi = videoApi, this._chatApi = chatApi, null !== (_window$teleparty = window.teleparty) && void 0 !== _window$teleparty && _window$teleparty.replaceScriptLoaded || (debug("injecting replace script"), 
            ...
            stopListening() {
                this._videoCheckInterval && clearInterval(this._videoCheckInterval), this._stateTimerInterval && clearTimeout(this._stateTimerInterval), 
                window.removeEventListener("mouseup", this._onInteraction), window.removeEventListener("keyup", this._onInteraction), 
                window.removeEventListener("message", this._onReplace, !1);
            }
        ...
        class NetflixPageControls extends class {
            ...
            startEventListener() {
                document.arrive("[data-uia='control-back10']", (() => {
                    this.showTpIcon();
                })), document.leave("[data-uia='control-back10']", (() => {
                    this.hideTpIcon();
            ...
            stopEventListener() {
                document.unbindArrive(), document.unbindLeave(), jQuery("#tp-buttons-container").off("hover");
            }
        }
        class NetflixContentScript extends class {
            ...
            constructor() {
                const netflixVideoApi = new NetflixVideoApi, netflixChatApi = new NetflixChatApi, videoEventListener = new NetflixVideoEventListener(netflixVideoApi, netflixChatApi);
                let pageControls;
        ...
        window.teleparty && window.teleparty.contentScriptInjected || (window.teleparty || (console.log("Set Teleparty"), 
