        ...
        5289: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
            ...
            class SocketWrapper {
                constructor(socketUrl, socketEventHandler) {
                    ...
                    SocketWrapper_defineProperty(this, "_socket", void 0), SocketWrapper_defineProperty(this, "_keepAliveInterval", void 0), 
                    SocketWrapper_defineProperty(this, "_callbackManager", void 0), SocketWrapper_defineProperty(this, "_userId", void 0), 
                    SocketWrapper_defineProperty(this, "_sessionId", void 0), SocketWrapper_defineProperty(this, "_reconnectTimeOut", void 0), 
                    SocketWrapper_defineProperty(this, "_reconnectAttempts", void 0), this._socketEventHandler = socketEventHandler, 
                    this._socketUrl = socketUrl, this._reconnectAttempts = 0, this._callbackManager = new SocketCallbackManager, 
                    console.time("ping"), this._socket = new WebSocket(this._socketUrl), this._handleSocketEvents();
                }
                ...
                _handleSocketEvents() {
                    ...
                    this._keepAliveInterval = setInterval(this._ping.bind(this), 45e3);
                }
                _ping() {
                    1 == this._socket.readyState && this._socket.send(JSON.stringify({
                        type: "ping"
                    }));
                }
                _onOpen() {
                ...
                _onClose(event) {
                    if (this._keepAliveInterval && clearInterval(this._keepAliveInterval), 4500 !== event.code) {
                        if (debug("Websocket lost connection"), 1007 === event.code) {
                            const logData = {
                                sessionId: this._sessionId,
                                eventType: "socket-close-" + event.code
                            };
                            Background_BackgroundService.logEventAsync(logData);
                        }
                        this._doReconnect();
                    } else debug("Websocket connection closed manually");
                }
                ...
                _onError(event) {
                    debug("WebSocket error observed:", event), this._socket.close(), this._keepAliveInterval && clearInterval(this._keepAliveInterval);
                }
                _onMessage(event) {
                    try {
                ...
                teardown() {
                    ...
                    this._keepAliveInterval && clearInterval(this._keepAliveInterval);
                }
            ...
            const BackgroundService = new class {
                ...
                receiveMessage(message, sender, sendResponse) {
                    if ("Service_Background" === message.target) {
                        if (message.type == PopupMessageType.CREATE_SESSION) {
                            ...
                            var _sender$tab$id, _sender$tab;
                            if (0 === data.extensionTabData.id) data.extensionTabData.id = null !== (_sender$tab$id = null === (_sender$tab = sender.tab) || void 0 === _sender$tab ? void 0 : _sender$tab.id) && void 0 !== _sender$tab$id ? _sender$tab$id : 0;
                        ...
                        if (message.type == PopupMessageType.RE_INJECT) {
                            ...
                            var _sender$tab$id2, _sender$tab2;
                            if (0 === data.extensionTabData.id) data.extensionTabData.id = null !== (_sender$tab$id2 = null === (_sender$tab2 = sender.tab) || void 0 === _sender$tab2 ? void 0 : _sender$tab2.id) && void 0 !== _sender$tab$id2 ? _sender$tab$id2 : 0;
                            return this.reInjectCS(data).then(sendResponse).catch(this.receiveMessageOnError(sendResponse)), 
                            !0;
                        }
                    }
                }
                async reInjectCS(data) {
                    const extensionTab = data.extensionTabData;
                    await this.dataManager.initContentScriptsAsync(extensionTab);
                }
                ...
                async createSessionAsync(createSessionData) {
                    ...
                    const userSettings = this.getUserSettingsForStorageData(storageData), createData = {
                        ...
                        videoService: null == streamingService ? void 0 : streamingService.serverName,
                        messages: []
                    }), response = await this.onCreateSessionDataReceivedAsync(sessionData, extensionTabData.id, storageData, createSessionData.pageControls);
                ...
                async onCreateSessionDataReceivedAsync(callbackData, tabId, storageData, pageControls) {
